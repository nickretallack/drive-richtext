...
(function() {
  ...
  CollaborativeRichText = (function() {
    ...
    CollaborativeRichText.prototype.setup_model = function(parent, name) {
      ...
      this.overlays = this.get_or_create_field(this.model.createList, this.obj, 'overlays');
      return this.auto_incrementer = this.overlays.length ? this.overlays.get(this.overlays.length - 1).get('id') : 0;
    };
    ...
    CollaborativeRichText.prototype.run_initial_events = function(handlers) {
      ...
      if (handlers.preview_overlay) {
        this.overlays.asArray().forEach(handlers.preview_overlay);
      }
    ...
    CollaborativeRichText.prototype.create_overlay = function(start_index, end_index, attribute) {
      ...
      start_ref = this.str.registerReference(start_index, gapi.drive.realtime.IndexReference.DeleteMode.SHIFT_BEFORE_DELETE);
    ...
    CollaborativeRichText.prototype.insertText = function(index, text, attributes) {
      ...
      this.formatText(index, index + text.length, attributes);
    };
